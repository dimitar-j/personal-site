...
export default function Contact() {
    ...
    const handleSubmit = () => {
        if (name === "" || email === "" || message === ""){
            ...
            setSubmitting(true)
            axios.post('https://41l9b8a1xf.execute-api.us-east-1.amazonaws.com/default/helloWorld', {
                name: name,
                email: email,
                message: message
              }, {
              ...
              .catch(function (error) {
                  setSuccess(false)
                  setFail(true)
                  setErrorMessage("Email could not be sent. Please try again later, or email me directly at dimitar.j27@gmail.com.")
              });
